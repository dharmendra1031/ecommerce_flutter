...
mixin _$PaginatedResponse<T> {
  List<T> get products => throw _privateConstructorUsedError;
...
abstract class $PaginatedResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({List<T> products, Pagination pagination});
...
class _$PaginatedResponseImpl<T> implements _PaginatedResponse<T> {
  const _$PaginatedResponseImpl(
      {required final List<T> products, required this.pagination})
      : _products = products;
  ...
  @override
  String toString() {
    return 'PaginatedResponse<$T>(products: $products, pagination: $pagination)';
  }
...
abstract class _PaginatedResponse<T> implements PaginatedResponse<T> {
  const factory _PaginatedResponse(
      {required final List<T> products,
...
abstract class _Pagination implements Pagination {
  const factory _Pagination(
      ...
      required final int pages}) = _$PaginationImpl;
